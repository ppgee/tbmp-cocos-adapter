...
var nameChar = new RegExp("[\\-\\.0-9" + nameStartChar.source.slice(1, -1) +
  "\\u00B7\\u0300-\\u036F\\u203F-\\u2040]");
var tagNamePattern = new RegExp('^' + nameStartChar.source + nameChar.source + '*(?:\:' + nameStartChar
  .source + nameChar.source + '*)?$');
    ...
    try {
      ...
      switch (source.charAt(tagStart + 1)) {
        case '/':
          ...
          var endIgnoreCaseMach = endMatch || config.tagName && config.tagName.toLowerCase() ==
            tagName.toLowerCase()
        ...
        default:
          ...
          if (el.uri === 'http://www.w3.org/1999/xhtml' && !el.closed) {
            end = parseHtmlSpecialContent(source, end, el.tagName, entityReplacer,
              domBuilder)
          } else {
            end++;
          }
        ...
        switch (s) {
          ...
          case S_ATTR_SPACE:
            ...
            if (s == S_ATTR_NOQUOT_VALUE) {
              ...
              if (currentNSMap[''] !== 'http://www.w3.org/1999/xhtml' || !value.match(
        ...
        if (c <= ' ') { //space
          ...
          switch (s) {
            ...
            case S_ATTR_SPACE:
              ...
              if (currentNSMap[''] !== 'http://www.w3.org/1999/xhtml' || !attrName.match(
                /^(?:disabled|checked|selected)$/i)) {
